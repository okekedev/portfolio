  ...
  return (
    <main>
      ...
      <section className="hero fade-in">
        <h1>
          <FadeInText text="Gronk Privacy Policy 🔒" />
        </h1>
        <p>
          <FadeInText
            text="Your privacy is important to us. This policy explains how we collect, use, and protect your information. 🛡️"
            delay={500}
          />
        </p>
      </section>
      ...
      <section className="about-section fade-in">
        ...
        <p>
          This Privacy Policy describes how E&J Products LLC dba Sundai ("we," "us," or "our") collects, uses, and shares your personal information when you use our Gronk application ("the App").
        </p>
        <p>
        ...
        <p>
          We collect information that you voluntarily provide when using our App, which may include:
        </p>
        <ul>
          <li>Your inputs and messages to the AI assistant</li>
          <li>Account information when you subscribe to premium features</li>
        ...
        <h3>3. Local Storage and Data Privacy</h3>
        <p>
          Gronk is designed with privacy in mind:
        </p>
        <ul>
          <li>Your conversations are stored locally on your device by default</li>
          <li>We use offline AI processing capabilities where possible</li>
          <li>CloudKit sync is optional and only transfers data between your own devices when enabled</li>
          <li>We do not collect or store the content of your conversations on our servers</li>
        </ul>
        ...
        <ul>
          <li>With service providers who help us operate the App (e.g., cloud storage providers, payment processors)</li>
        ...
        <h3>5. Apple App Store and In-App Purchases</h3>
        <p>
          When you make in-app purchases through the App Store:
        </p>
        <ul>
          <li>Apple processes your payment information according to their privacy policy</li>
          <li>We receive only limited transaction information necessary to verify your subscription status</li>
